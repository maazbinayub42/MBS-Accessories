var AdminApp = (function () {
  ...
  var SIDEBAR_SECTIONS = [
    {
      ...
      links: [
        ...
        { label: 'View Site', href: '../index.html', external: true, icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>' }
      ]
    },
    {
      title: 'WEBSITE',
  ...
  function renderHomepageCMS() {
    ...
    sections.forEach(function (sec) {
      ...
      html += '<div class="section-editor__header" onclick="AdminApp.toggleSection(\'' + sec.key + '\')">';
  ...
  function renderPages() {
    ...
    pages.forEach(function (page) {
      ...
      html += '<div class="section-editor__header" onclick="AdminApp.togglePage(\'' + page.key + '\')">';
